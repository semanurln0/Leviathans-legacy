...
class Buildings:
    ...
    def Upgrade(self, player1):
        if player1.steel >= self.__BuildCost and self.__UpgradePossible == True and self.__Buyable == True and self.__BuildingsStage >= 0:
            ...
            pygame.time.set_timer(pygame.USEREVENT,
                                  self.__BuildTime * 1000)  # I am not sure if this will work We need to test it also may need edit
            self.__IncreaseBuildTimer()
    ...
    def Print_Info(self, player1):  # basicly For checking we can delete this any time
