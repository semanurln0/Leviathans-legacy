...
class OverviewUI:
    def __init__(self, screen, background_filename, mplayer):
        ...
        self.running = True  # Add a running flag for the game loop
    ...
    def handle_events(self, events):
        for event in events:
            ...
            for button in self.top_bar.buttons:
...
def overview_ui(mplayer):
    ...
    print(data)
    while ui.running:  # Use the running flag to control the game loop
